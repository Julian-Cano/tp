...
| Req      | Detalle                                                                                                                                                                                                                                                                                                                                                                                  |
| :------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Listados | 1. 1. Listado de productos filtrado por objetivo (volumen, definición, rendimiento), marca y rango de precio, muestra nombre, precio y disponibilidad ⇒ detalle muestra información completa del producto <br>2. 2. Listado de pedidos filtrado por rango de fecha y estado, muestra número de pedido, cliente, total y estado ⇒ detalle muestra productos incluidos y datos del cliente |
| CUU/Epic | 1. Aplicar descuento/cupón a pedido <br>2. 2. Seguimiento de pedido (cambio de estado: pendiente, enviado entregado)                                                                                                                                                                                                                                                                     |
| Otros    | 1.Notificación de producto sin stock / reposición (email o alerta en sistema) <br>2. 2. Sistema de valoración y reseñas de productos                                                                                                                                                                                                                                                     |
